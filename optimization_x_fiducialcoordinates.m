...
for j = 1:length(FolderNames)
    ...
    for k = 1:length(subFolderNames)
        % the text file with the fiducial coordinates is obtained after
        % point detection (PD) and is found in the Output PD folder
...
% % % % % % Optimization for X Coordinates of the Fiducials
